...
**For LLMs helping users develop plugins:** Start with `AGENTS.md` (root) + `wiki/LLM-INSTRUCTIONS.md` (focus on usage/query workflow and Fandom priority). This is the thin entry point for low-friction, everyday plugin work. Regular users should prefer existing Fandom plugins over new code whenever possible.
